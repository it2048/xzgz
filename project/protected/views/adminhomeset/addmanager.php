<form id="pagerForm" onsubmit="return navTabSearch(this);" action="<?php echo Yii::app()->createAbsoluteUrl('adminhomeset/addmanager'); ?>" method="post">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" mask="true" height="560" width="600" target="dialog" href="<?php echo Yii::app()->createAbsoluteUrl('adminhomeset/addadd');?>"><span>添加</span></a></li>
        </ul>
    </div>
        ...
        <?php foreach ($models as $value) {?>
            <tr>
                ...
                <td>
                    ...
                    <a title="编辑" height="560" mask="true" width="620" target="dialog" href="<?php echo Yii::app()->createAbsoluteUrl('adminhomeset/addedit',array('id'=>$value['id'])); ?>" class="btnEdit">编辑</a>
                    <?php
                    if($value['comtype']==0){
                        ?>
