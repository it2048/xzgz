...
<div class="pageContent">
    <form method="post" action="<?php echo Yii::app()->createAbsoluteUrl('homeshop/newsupdate'); ?>" class="pageForm required-validate" onsubmit="return iframeCallback(this, viData);" enctype="multipart/form-data">
        <div class="pageFormContent" layoutH="56">
            ...
            <p class="nowrap">
                ...
                <input  name="shop_taste" type="text" class="required" size="10" value="<?php echo $models->taste;?>">
                <input  name="shop_suround" type="text" class="required" size="10" value="<?php echo $models->suround;?>">
                <input  name="shop_service" type="text" class="required" size="10" value="<?php echo $models->service;?>">
            </p>
            <p class="nowrap">
                <label>电话：</label>
            ...
            <p class="nowrap">
                <label>人均消费：</label>
                <input  name="shop_money" id="shop_desc" type="text" class="textInput" size="50" value="<?php echo $models->money;?>">
            </p>
            <p class="nowrap">
                <label>地址描述：</label>
            ...
            <p class="nowrap">
                <label>描述标签：</label>
                <input  name="shop_tag" id="shop_add" type="text" class="textInput" size="50" value="<?php echo $models->tag;?>">
            </p>
...
?>                        
            ...
            <p>
                <textarea class="editor" upImgUrl="<?php echo Yii::app()->createAbsoluteUrl('homenews/imgupload'); ?>" upImgExt="jpg,jpeg,gif,png" name="shop_content" rows="21" cols="74" ><?php echo $models->content;?></textarea>
            </p>
        </div>
        <div class="formBar">
            <ul>
