<div class="pageContent">
    <form method="post" action="<?php echo Yii::app()->createAbsoluteUrl('admincontent/usernewsave'); ?>" class="pageForm required-validate" onsubmit="return iframeCallback(this, viData);" enctype="multipart/form-data">
        <div class="pageFormContent" layoutH="56">
            <p>
                <label>旧密码：</label>
                <input type="password" id="old_password" name="oldpassword" size="30" minlength="6" maxlength="20" class="required alphanumeric textInput valid">
            </p>
            <p>
                <label>密码：</label>
            ...
            <p>
                <label>联系电话：</label>
                <input  name="tel" type="text" class="textInput" size="30" value="<?php echo empty($models->tel)?"":$models->tel;?>">
            </p>
            <p>
                <label>邮箱：</label>
                <input  name="email" type="text" class="textInput" size="30" value="<?php echo empty($models->email)?"":$models->email;?>">
            </p>
        </div>
        <div class="formBar">
            <ul>
