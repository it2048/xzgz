<div class="pageContent">
    <form method="post" action="<?php echo Yii::app()->createAbsoluteUrl('homeconvenient/update'); ?>" class="pageForm required-validate" onsubmit="return iframeCallback(this, viData);" enctype="multipart/form-data">
...
?>                        
            ...
            <div class="divider"></div>
            <p class="nowrap"><label>便民点内容：</label></p>
            <p>
